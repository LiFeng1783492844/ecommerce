...
<div class="container">
    ...
    <div class="content">
        <div class="left">用户名：</div><div class="right"><label id="account"></label></div><br>
        <div class="left">密码：</div><div class="right"><input type="text" id="pass"></div><br>
        ...
        <div class="left">真实姓名：</div><div class="right"><input type="text" id="name"></div><br>
    </div>
    <div class="button">
